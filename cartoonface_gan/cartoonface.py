...
class Config(object):
    ...
    decay_every  = 20
    netd_path    = 'checkpoints/netd_3.pth'
    netg_path    = 'checkpoints/netg_3.pth'
...
def train(**kwargs):
    ...
    dataset = torchvision.datasets.ImageFolder(opt.data_path, transform = trans)
    ...
    for epoch in iter(epochs):
        ...
        if (epoch+1) % opt.save_every == 0:
            ...
            #torchvision.utils.save_image(fix_fake_imgs.data[:64], '%s/%s.png' % (opt.save_path, epoch),normalize=True, range=(-1, 1))
